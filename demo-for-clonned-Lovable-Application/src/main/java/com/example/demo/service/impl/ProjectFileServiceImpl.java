...
import com.example.demo.mapper.ProjectFileMapper;
...
public class ProjectFileServiceImpl implements ProjectFileService
{
    ...
    public void saveFile(Long projectId, String filePath, String fileContent) {
        Project project = projectRepository.findById(projectId).orElseThrow(() -> new ResourceNotFoundException("Project is not found"));
